...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'hentry-post group blog-49bf8aa' ); ?>>   
    <!-- post featured & title -->
    <?php
    if( get_post_format() == 'quote' ) :
        yit_get_template( 'blog/49bf8aa/post-formats/quote.php' );  
    else :
    ?>                
    <div class="<?php if ( ! $has_thumbnail ) echo 'without ' ?>thumbnail">
        <div class="row">
            ...
            <div class="image-wrap span4">
                <?php the_post_thumbnail( 'blog_49bf8aa' ); ?>
            </div>
            <?php endif ?>
