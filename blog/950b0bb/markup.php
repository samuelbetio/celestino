...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'hentry-post group span3 blog-950b0bb' ); ?>> 
	<div class="blog-item <?php echo !$has_thumbnail ? 'without thumbnail' : '' ?>">
    <?php
    if( get_post_format() == 'quote' ) :
        yit_get_template( 'blog/950b0bb/post-formats/quote.php' );  
    else :
    ?>     
		
		<?php if( $has_thumbnail ) : ?>
		<div class="picture_overlay">
			<a href="<?php the_permalink() ?>"><?php the_post_thumbnail( 'thumb_portfolio_950b0bb' ); ?></a>
		</div>
		<?php endif ?>
